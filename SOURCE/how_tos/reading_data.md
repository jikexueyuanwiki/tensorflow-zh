...
[`placeholder` op](tensorflow-zh/SOURCE/api_docs/python/io_ops.md#placeholder) node. A
...
and is described in the [MNIST tutorial](tensorflow-zh/SOURCE/tutorials/mnist/tf/index.md).
