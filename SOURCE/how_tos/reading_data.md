...
[`TextLineReader`](tensorflow-zh/SOURCE/api_docs/python/io_ops.md#TextLineReader) with the
[`decode_csv`](tensorflow-zh/SOURCE/api_docs/python/io_ops.md#decode_csv) operation. For example:
...
[`tf.train.shuffle_batch_join` function](tensorflow-zh/SOURCE/api_docs/python/io_ops.md#shuffle_batch_join).
For example:
